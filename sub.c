...
void imgSub(ImgMat *src1,ImgMat *src2,ImgMat *dst)
{
	...
	if((type_s1 == TYPE_8U)&&(type_s2 == TYPE_8U)&&(type_d == TYPE_8U))
	{
		...
		IMG_SUB(p_src1_1,p_src2_1,p_dst_1);
	}
	else if((type_s1 == TYPE_8S)&&(type_s2 == TYPE_8U)&&(type_d == TYPE_8U))
	{
		...
		IMG_SUB(p_src1_2,p_src2_2,p_dst_2);
	}
	else if((type_s1 == TYPE_8U)&&(type_s2 == TYPE_8S)&&(type_d == TYPE_8U))
	{
		...
		IMG_SUB(p_src1_3,p_src2_3,p_dst_3);
	}
	else if((type_s1 == TYPE_8S)&&(type_s2 == TYPE_8S)&&(type_d == TYPE_8U))
	{
		char *p_src1_4;
		p_src1_4 = (char *)src1->data.ptr;
		char *p_src2_4;
		p_src2_4 = (char *)src2->data.ptr;
		unsigned char *p_dst_4;
		p_dst_4 = dst->data.ptr;
		
		IMG_SUB(p_src1_4,p_src2_4,p_dst_4);
	}
	#undef TYPE_D
	#define TYPE_D char
	else if((type_s1 == TYPE_8U)&&(type_s2 == TYPE_8S)&&(type_d == TYPE_8S))
	{
		...
		IMG_SUB(p_src1_5,p_src2_5,p_dst_5);
	}
	else if((type_s1 == TYPE_8S)&&(type_s2 == TYPE_8S)&&(type_d == TYPE_8S))
	{
		...
		IMG_SUB(p_src1_6,p_src2_6,p_dst_6);
	}
	else if((type_s1 == TYPE_8S)&&(type_s2 == TYPE_8U)&&(type_d == TYPE_8S))
	{
		char *p_src1_7;
		p_src1_7 = (char *)src1->data.ptr;
		unsigned char *p_src2_7;
		p_src2_7 = src2->data.ptr;
		char *p_dst_7;
		p_dst_7 = (char *)dst->data.ptr;
		
		IMG_SUB(p_src1_7,p_src2_7,p_dst_7);		
	}
	else if((type_s1 == TYPE_8U)&&(type_s2 == TYPE_8U)&&(type_d == TYPE_8S))
	{
		unsigned char *p_src1_8;
		p_src1_8 = src1->data.ptr;
		unsigned char *p_src2_8;
		p_src2_8 = src2->data.ptr;
		char *p_dst_8;
		p_dst_8 = (char *)dst->data.ptr;
		
		IMG_SUB(p_src1_8,p_src2_8,p_dst_8);		
	}	
}
